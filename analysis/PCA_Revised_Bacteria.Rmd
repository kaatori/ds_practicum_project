...
- Note: This section uses the original abudance counts per bacteria ASV. 
- The revised analysis uses proportions per bacteria per sample row instead. Please refer to that analysis instead of this one. 
