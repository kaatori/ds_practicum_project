...
# pivoting data drame so that cumulatives are in column
  ...
  ggtitle("Clade C - PCA Results: Proportion of Variance", 
          "Vertical lines indicate Lasso number of non-zero coefficients\nLambda.1se = 4 predictors, Lambda.min = 23 predictors") +
  xlab("Cumulative Proportion") +
  ylab("Proportion of Variance per Principal Component") +
  theme_bw() +
  geom_vline( xintercept = 0.175, colour = "red") +
...
fviz_contrib(pca_clade_c, 
             ...
             axes = 1, 
             top = 400, 
             title = "Clade C Top Contributing ASVs in Dimension 1\nRed dashed line indicates average contribution", 
             xtickslab.rt = 0,
             #ylim(0.4, 0.7),
...
```
- Obtain List of first 1000 ASVs for testing Logistic Regression
```{r}
