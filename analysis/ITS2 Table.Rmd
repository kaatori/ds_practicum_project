...
```
- From the above, logging doesn't really seem to do much but squish the patterns that are already there, and there is no linear relationship between Clade and ITS2 count
