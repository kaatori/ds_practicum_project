...
#### Best Ridge Model 1000 from Training & Re-fit
```{r}
...
(16 + 19)/sum(16, 19, 7) # 42 testing rows
...
#### Best Lasso Model from Training & Re-fit
...
- The ridge classificiation model with 500 ASVs has the lowest error rate at 28.6 % but not by much since the one with 1000 ASVs. 

- The lower lasso error rate is the lasso model with 500 ASVs. 
